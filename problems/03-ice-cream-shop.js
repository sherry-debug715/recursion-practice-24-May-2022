...
function iceCreamShop(flavorsArr, favoriteStr) {
  if(!flavorsArr.length) return false;
  if (flavorsArr[0] === favoriteStr) return true;
  console.log(flavorsArr.slice(1))
  return iceCreamShop(flavorsArr.slice(1),favoriteStr);
}
